...
### - use to 
```sh
[bohdan@fedora testdirectory]$ top
```

![[Pasted image 20221012134632.png]]
...
1. COMMAND-LINE Options
       ...
       -c  :Command-line/Program-name toggle
            ...
            program names, and vice versa.  See the `c' interactive command for additional information.
 ...
 Manual page top(1) line 157/1625 11% (press h for help or q to quit)
       ...
       -O  :Output-field-names
            ...
            separate line, then quit.  Such names are subject to NLS (National Language Support) translation.
       ...
       -s  :Secure-mode operation
            Starts top with secure mode forced, even for root.  This mode is far better controlled through a system  configuration  file  (see
            topic 6. FILES).
       ...
       -u | -U  :User-filter-mode as:  -u | -U number or name
            ...
            Prepending  an  exclamation point (`!') to the user id or name instructs top to display only processes with users not matching the
            one provided.
       ...
       -w  :Output-width-override as:  -w [ number ]
            ...
            Otherwise,  width  will  be fixed at the maximum 512 columns.  With an argument, output width can be decreased or increased (up to
       ...
       -w  :Output-width-override as:  -w [ number ]
            ...
            variables,  if  set.  With an argument, output width can only be decreased, not increased.  Whether using environment variables or
            an argument with -w, when not in Batch mode actual terminal dimensions can never be exceeded.

            Note: Without the use of this command-line option, output width is always based on the terminal at which top was  invoked  whether
            or not in Batch mode.

       -1  :Single/Separate-Cpu-States toggle
            Starts top with the last remembered Cpu States portion of the summary area reversed.  Either all cpu information will be displayed
            in a single line or each cpu will be displayed separately, depending on the state of the NUMA Node command toggle ('2').
