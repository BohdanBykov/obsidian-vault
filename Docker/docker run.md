...
### - download image name container and run bash
```sh
[bohdan@fedora ~]$ docker run --name test -it debian
...
```sh
[bohdan@fedora ~]$ docker run --cidfile /tmp/cid ubuntu
[bohdan@fedora ~]$ ls /tmp
cid
```

### - run container and set custom path
```sh
[bohdan@fedora ~]$ docker run -w /custom/path -i -t --name pathtest ubuntu pwd
/custom/path
```

### - mount local directory in container
```sh
[bohdan@fedora testdirectory]$ docker run -w /customdir -v ~/testdirectory/container:/customdir -i -t ubuntu bash
root@90fe6fac70f3:/customdir# ls
root@90fe6fac70f3:/customdir# touch testfile
root@90fe6fac70f3:/customdir# exit
exit
[bohdan@fedora testdirectory]$ ls container
testfile
...
Options:
  ...
  -a, --attach list                    Attach to STDIN, STDOUT or STDERR
      ...
      --cgroupns string                Cgroup namespace to use (host|private)
                                       ...
                                       '': Use the cgroup namespace as configured 
                                       by the default-cgroupns-mode option on the 
                                       daemon (default)
  ...
  -d, --detach                         Run container in background and print 
      ...
      --device-cgroup-rule list        Add a rule to the cgroup allowed devices 
                                       list
